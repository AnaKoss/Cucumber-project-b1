...
public class  DocuportConstants {
    ...
    public static final String ERROR_MESSAGE_FOR_EMPTY_PASSWORD = "lease enter your password";
    ...
    public static final String EMAIL_FOR_FORGET_PASSWORD = "forgotpasswordg1@gmail.com";
    ...
    public static final String EMPLOYEE = "Employee-Tax";
